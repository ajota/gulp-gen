...
(function(){
    ...
    var gulpGen = function (appDirectory) {
        ...
        gulp.task('gen:config', function (done) {
        ...
        gulp.task('gen', gulp.series('gen:app', 'gen:config'), function (done) {
            var commonFiles = [
        ...
        gulp.task('gen:module', function (done) {
            var originalName;
            var camel;
            var _done = done;
        ...
        gulp.task('gen:submodule', function (done) {
        ...
        gulp.task('gen:controller', function (done) {
            name = process.argv.slice(3);
        ...
        gulp.task('gen:factory', function (done) {
        ...
        gulp.task('gen:routes', function (done) {
            name = process.argv.slice(3);
        ...
        gulp.task('gen:component', function (done) {
            name = process.argv.slice(3);
        ...
        gulp.task('gen:inject:generals', function (done) {
        ...
        gulp.task('gen:inject', gulp.series('gen:inject:generals'), genInject );
        ...
        gulp.task('gen:' + AppResources.appName + ':build', gulp.series('gen:' + AppResources.appName + ':publish'), function (done) {
